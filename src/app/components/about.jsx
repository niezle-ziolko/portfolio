  ...
  return (
    <div className="u1 u15 relative max-w-x">
      ...
      <div className="w-full">
        ...
        {/* Description */}
        <div className="u16 gap-1 md:gap-10 md:flex-row">
          <p
            ref={ref}
            className={`u14 [animation-delay:200ms] ${upClass} `}
          >
          ...
          <p
            ref={ref}
            className={`u14 [animation-delay:400ms] ${upClass}`}
          >
            ...
            Jednak w momencie premiery wersji produkcyjnej aplikacji musiałem zmierzyć się z wyzwaniami
            związanymi z samym frameworkiem,
          ...
          <p
            ref={ref}
            className={`u14 [animation-delay:600ms] ${upClass}`}
          >
